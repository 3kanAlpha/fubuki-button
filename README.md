...
Also you can submit [Issues](https://github.com/3kanAlpha/fubuki-button/issues) to upload audio clips.
...
Other parts: [MIT License](https://github.com/3kanAlpha/fubuki-button/blob/master/LICENSE)
